    ...
    <main>
      ...
      <Section scrollTarget>
        <TextListBlock>
          ...
          <QuoteElement quote="Our vision is to change the way we think about our finances, by prioritising sustainable capital growth." />
        </TextListBlock>
      </Section>
      ...
      <Section title="Upwood partners">
        <LogoListBlock>
          {[1, 2, 3, 4, 5, 6].map((item, index) => (
            <LogoElement key={index} image="/upwood.svg" alt="Partner" />
          ))}
        </LogoListBlock>
      </Section>
